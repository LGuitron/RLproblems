...
class RL:
    ...
    def __init__(self, batch_size, learning_rate , epsilon, discount , _lambda, experience_stored, step_delta, display_frequency):
        self.approximator = Approximator(batch_size,learning_rate, epsilon, _lambda, experience_stored, step_delta) 
