...
softmax_dqn_agent       = DQNAgent(board_size, "models/softmax_2M", model, model_name, AgentType.Softmax, temperature_vals, temperature_decay)
...
sim_games(egreedy_dqn_agent, rand_agent, board_size, connect_to_win, episodes=10000, doTraining=False, is_exploring=False, display_results = True)
sim_games(softmax_dqn_agent, rand_agent, board_size, connect_to_win, episodes=10000, doTraining=False, is_exploring=False, display_results = True)
sim_games(softmax_dqn_agent, egreedy_dqn_agent, board_size, connect_to_win, episodes=2, doTraining=False, is_exploring=False, display_results = True)

# Play against RL agent
# rendered_games(softmax_dqn_agent, human_agent, board_size, connect_to_win)
